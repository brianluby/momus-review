//! Merge-safety spike (#4): an uncalibrated P(revert) heuristic.
//!
...
//! #17 owns the real calibration against observed revert outcomes (and any
//! "merge confidence" derived as its complement).
//!
